...
/*
 1. 타임 테이블 지오메트리에 넣어서 아이패드 호환.
 2. 디자인요소 다시 점검하고 개선하기
 3. 프로그레스 버튼 클릭 시 기능을 뷰모델로 끌어올릴 방법 찾기
 4. 프로그레스 버튼 목표치 초과하는 것 개선하기
 5. 프로그레스 뷰 들어갈 때 overlay 숙주 뷰 크기 조절 버그 수정하기
