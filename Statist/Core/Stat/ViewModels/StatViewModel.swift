...
//    @Published var todoEntitys: [TodoEntity] = []
//    @Published var prevWeekTodoEntitys: [TodoEntity] = []
//    var percent: Double {
...
//        let request = NSFetchRequest<TodoEntity>(entityName: "TodoListEntity")
...
//    private func calPercent(_ entity: [TodoEntity]) -> Double {
...
//    }
//    
//    private func calCount(_ entity: [TodoEntity]) -> Int {
